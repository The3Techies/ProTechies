    ...
    <div className="bg-PrimaryBg w-full flex justify-around bg-right">
      <div id="AboutUs" className="w-[90%] 2xl:w-[70%]  flex lg:flex-row flex-col justify-between items-center py-6 gap-8 mb-10">
        ...
        <div className="lg:w-[50%] ">
          <h1 className="text-[#FFF] font-bold text-3xl lg:text-4xl 2xl:text-6xl border-l-[5px] border-Highlight lg:mt-0 mt-10 pl-4 mb-6 ">О нас</h1>

          <h1 className="pl-4 font-bold text-xl 2xl:text-3xl text-[#FFF] mb-2">Наша страсть к инновациям</h1>
          <p className="pl-4 text-[#FFF] mb-4 max-w-[95%] text-sm 2xl:text-lg">В <span className="text-Highlight font-bold">ProTechies</span> Мы - команда преданных страстным энтузиастам технологий, нацеленных на стимулирование цифровых инноваций. Наша общая миссия двигает нас вперёд, поскольку мы стремимся предоставлять выдающиеся услуги разработки, превосходящие воображение и воплощающие идеи в жизнь.</p>
