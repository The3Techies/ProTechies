...
const projectsHtml = projects.map((section, index) => (
    <div key={index} className="relative bg-SecondaryBg bg-opacity-[0.12] rounded-2xl shadow-[4px_4px_4px_0px] shadow-Highlight lg:w-[31.8%] md:w-[47%] w-full aspect-[1/0.7] px-2 " >
