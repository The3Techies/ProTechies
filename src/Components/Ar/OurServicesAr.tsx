...
const servicesHtml = services.map((section, index) => (
  <div key={index} dir="rtl" className="bg-[#fff] bg-opacity-[0.12] rounded-2xl shadow-[4px_4px_4px_0px_rgba(0,223,192,1)] md:w-[31%] flex flex-col items-center  px-2 py-6">
    ...
    <p className="text-[#FFF] text-sm md:text-base 2xl:text-lg text-center p-2">{section.discretion}</p>
  ...
  return (
    <div className="bg-[#334A5C] w-full flex justify-around " >
      <div id="OurServices" className="w-[90%] 2xl:w-[70%] mb-12">
        ...
        <h1 className="text-[#FFF] font-bold text-3xl md:text-4xl 2xl:text-6xl border-r-[5px] border-[#00DFC0] pr-4 mb-10 text-right">الخدمات التي نقدمها</h1>
