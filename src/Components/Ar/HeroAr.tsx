    ...
    <div className="bg-[#334A5C] lg:w-full lg:h-screen flex flex-row-reverse justify-around ">
      <div id="Hero" className="w-[90%] 2xl:w-[70%] flex flex-col lg:flex-row justify-center items-center mt-10 lg:mt-0">
        ...
        <div className="lg:w-[50%] lg:h-full h-full bg-[url(/HeroImgs/bg.webp)] bg-no-repeat bg-contain flex flex-col justify-center animate__animated animate__rollIn ">
          <h1 className="text-[#00DFC0] lg:text-2xl 2xl:text-4xl font-bold mb-4 animate__animated max-w-[90%] text-right ">تحويل الرؤى والأفكار إلى حقيقة</h1>
          ...
          <h1 className="bg-[#00DFC0] cursor-pointer w-fit px-12 py-4 text-xl 2xl:text-3xl rounded-3xl font-bold transform transition-transform lg:hover:scale-125 hover:scale-110 hover:bg-[#00A89C] hover:transition  hover:duration-1000 hover:text-white" onClick={()=>handleScrollToComponent()}>تواصل معنا</h1>
        </div>
